...
class _CadastroState extends State<Cadastro> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetBuilder<CadastroContoller>(
          builder: (controller) {
            return cadastroContoller.habilidade.isEmpty ||
                    cadastroContoller.tipo.isEmpty ||
                    cadastroContoller.categoria.isEmpty
                                      ...
                                      GetBuilder<CadastroContoller>(
                                        builder: (controller) {
                                          return SizedBox(
                                              width: 100,
                                              height: 100,
                                              child: cadastroContoller
                                                          .imagemPokemon !=
                                                      null
                                                  ? Image.file(cadastroContoller
                                                      .imagemPokemon!)
                                                  : Image.asset(
                                                      'assets/pokeball.png',
                                                    ));
